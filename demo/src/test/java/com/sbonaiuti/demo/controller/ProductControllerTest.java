package com.sbonaiuti.demo.controller;


import com.sbonaiuti.demo.model.Product;
import com.sbonaiuti.demo.service.ProductService;
...
class ProductControllerTest {
    ...
    public void shouldGetSimilarProductsOk() {
        Product p1 = new Product("1", "Shirt", 19.99, true);
        Product p2 = new Product("2", "Pants", 39.99, true);
